...
/**
 * Nothing registers a service worker any more — see src/sw.js. The file is
 * still built and served, but only so that browsers already holding the
 * withdrawn one can find its replacement and let themselves out.
 */
